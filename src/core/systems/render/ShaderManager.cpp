...
ShaderManager::ShaderManager() :
	vertexShaderSource(readContentFromFile(std::string(SHADER_PATH).append(std::string(VERT_SHADER)))),
	fragmentShaderSource(readContentFromFile(std::string(SHADER_PATH).append(std::string(FRAG_SHADER)))),
