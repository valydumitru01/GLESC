...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event *event) {
    ...
    switch (event->type) {
        ...
        case SDL_MOUSEBUTTONUP: {
            ...
            bd->MouseButtonsDown =
                    (event->type == SDL_MOUSEBUTTONDOWN) ? (bd->MouseButtonsDown | (1 << mouse_button)) : (
        ...
        case SDL_KEYUP: {
            ...
            io.SetKeyEventNativeData(key, event->key.keysym.sym, event->key.keysym.scancode, event->key.keysym
...
static void ImGui_ImplSDL2_UpdateMouseCursor() {
    ...
    if (io.MouseDrawCursor || imgui_cursor == ImGuiMouseCursor_None) {
        ...
        SDL_SetCursor(bd->MouseCursors[imgui_cursor] ? bd->MouseCursors[imgui_cursor] : bd
