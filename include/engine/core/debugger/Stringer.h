...
namespace GLESC {
    ...
    class Stringer {
        ...
        static inline std::string nonIterableToString(const Type &value) {
        ...
        static inline std::string iterableToString(const Iterable &iterable) {
            std::ostringstream oss;
            oss << "{";
    ...
    public:
        template<typename Type>
        static inline std::string toString(const Type &value) {
