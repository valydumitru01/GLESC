...
public:
    ...
    virtual void drawTrianglesIndexedInstanced(GAPI::UInt count, GAPI::UInt instanceCount) = 0;
    ...
    virtual void setDynamicBufferData(GAPI::UInt size, GAPI::BufferTypes bufferType) = 0;

    virtual void setIndexBufferData(const GAPI::UInt* data, GAPI::Size count, GAPI::BufferUsages buferUsage) = 0;
    ...
    virtual void setVertexAttribDivisor(GAPI::UInt index, GAPI::UInt divisor) = 0;
