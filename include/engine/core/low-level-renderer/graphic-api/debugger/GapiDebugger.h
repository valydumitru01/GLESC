 ...
 * @date   04/12/2023
 * @brief  Debugging utilities for the GAPI.
 *
...
namespace GLESC::GAPI::Enums {
    /**
     * @brief Converts the type count to string
     * @param typeCount
     * @return string representation of the type count
     */
    ...
    /**
     * @brief Converts internal format of the texture to string
     * @param internalFormat
     * @return string representation of the internal format
     */
    ...
    /**
     * @brief Converts CPU buffer format to string
     * @param format
     * @return string representation of the CPU buffer format
     */
    ...
    /**
     * @brief Converts the type to string
     * @param type
    ...
    /**
     * @brief Converts the buffer type to string
     * @param type
     * @return string representation of the buffer type
     */
    ...
    /**
     * @brief Converts the buffer usage to string
     * @param type
     * @return string representation of the buffer usage
     */
    ...
    /**
     * @brief Converts the buffer access to string
     * @param type
     * @return string representation of the buffer access
     */
    ...
    /**
     * @brief Converts the shader type to string
     * @param type
     * @return string representation of the shader type
     */
    ...
    /**
     * @brief Converts the depth parameters to string
     * @param type
     * @return string representation of the depth parameters
     */
    ...
    /**
     * @brief Converts the blending parameters to string
     * @param type
     * @return string representation of the blending parameters
     */
    ...
    /**
     * @brief Converts the culling parameters to string
     * @param type
     * @return string representation of the culling parameters
     */
    ...
    /**
     * @brief Converts the polygon mode parameters to string
     * @param type
     * @return string representation of the polygon mode parameters
     */
    ...
    /**
     * @brief Converts the primitive type to string
     * @param type
    ...
    /**
     * @brief Converts the capabilities to string
     * @param type
     * @return string representation of the capabilities
     */
    ...
    /**
     * @brief Converts the texture type to string
     * @param type
     * @return string representation of the texture type
     */
