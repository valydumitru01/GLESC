 ...
 * @see VectorBasicAlgorithms.h for more details on why this is needed.
 *
...
namespace GLESC::Math {
    ...
    public:
        ...
        matrixScalarDiv(const MatrixData<Type, N, M> &matrix, const Type &scalar, MatrixData<Type, N, M> &result) {
            S_ASSERT(scalar != 0, "Division by zero is not allowed.");
            matrixMulScalar(matrix, Type(1) / scalar, result);
        }
        ...
        template<typename Type, size_t N, size_t M>
        static inline void determinant2x2(const MatrixData<Type, N, M> &matrix, Type &result) {
         ...
         */
        template<typename Type, size_t N, size_t M>
        static inline void determinant3x3(const MatrixData<Type, N, M> &matrix, Type &result) {
         ...
         */
        template<typename Type, size_t N, size_t M>
        static inline void determinant4x4(const MatrixData<Type, N, M> &matrix, Type &result) {
            Type det;
        ...
        gaussianElimination(const MatrixData<Type, N, M> &inputMatrix) {
        ...
        gaussianEliminationData(const MatrixData<Type, N, M> &matrix) {
            MatrixData<Type, N, M * 2> augmentedMatrix;
            MatrixData<Type, N, M> identityMatrix;
            MatrixData<Type, N, M> inverseResult;
            
            // Initialize identity matrix
            MatrixBasicAlgorithms::setMatrixDiagonal(identityMatrix, Type(1));
        ...
        static inline Type laplaceExpansionDeterminant(const MatrixData<Type, N, N> &matrix) {
            if constexpr (N == 1) {
                ...
                Type det;
                MatrixBasicAlgorithms::determinant2x2(matrix, det);
                return det;
            } else if constexpr (N == 3) {
                Type det;
                MatrixBasicAlgorithms::determinant3x3(matrix, det);
                return det;
            } else if constexpr (N == 4) {
                Type det;
                MatrixBasicAlgorithms::determinant4x4(matrix, det);
                return det;
            } else {
                Type result = Type();
                Type sign = 1;
